    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(unet):
                ...
                encoder_hidden_states = batch["input_ids"]#text_encoder(batch["input_ids"].to(accelerator.device))[0]
        ...
        if accelerator.is_main_process:
            if args.validation_prompt is not None and epoch % args.validation_epochs == 0:
                ...
                pipeline = DiffusionPipeline.from_pretrained(
                    args.pretrained_model_name_or_path,cache_dir=args.cache_dir,
    ...
    if accelerator.is_main_process:
        ...
        if args.push_to_hub:
            save_model_card(
                repo_id,
                images=images,
                base_model=args.pretrained_model_name_or_path,cache_dir=args.cache_dir,
